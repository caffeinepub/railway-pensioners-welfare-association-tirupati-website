    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>View all your room booking requests</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>My Bookings</CardTitle>
        <CardDescription>
          View all your room booking requests ({bookings.length} total)
        </CardDescription>
      </CardHeader>
      <CardContent>
                ...
                <div className="space-y-3">
                  ...
                  {booking.status === BookingStatus.pending && (
                    <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-sm text-blue-900 dark:text-blue-100">
                      Your booking request is pending admin approval. You will
